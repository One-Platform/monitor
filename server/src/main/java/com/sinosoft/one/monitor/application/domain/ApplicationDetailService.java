...
public class ApplicationDetailService {
        ...
        ScheduledFuture scheduledFuture = scheduledExecutorService.scheduleAtFixedRate(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    for(Url url : urls) {
                        UrlResponseTime urlResponseTime = urlResponseTimeRepository.selectUrlResponseTimesForMonitorUrl(url.getId(), startDate, endDate,appId);
	...
	public List<UrlResponseTime> queryUrlResponseTimes(String applicationId) {
		...
		List<UrlResponseTime> urlResponseTimes = new ArrayList<UrlResponseTime>();
		for(Url url : urls) {
			UrlResponseTime urlResponseTime = urlResponseTimeRepository.selectUrlResponseTimesForMonitorUrl(url.getId(), startDate, endDate,applicationId);
			urlResponseTime = urlResponseTime == null ? new UrlResponseTime() : urlResponseTime;
