...
public class MethodResponseTime {
    ...
    private String avgResponseTimeStr ;
    private String minResponseTimeStr ;
    private String maxResponseTimeStr ;
    ...
    @Transient
    public String getAvgResponseTimeStr() {
        return avgResponseTimeStr;
    }

    @Transient
    public String getMinResponseTimeStr() {
        return minResponseTimeStr;
    }

    @Transient
    public String getMaxResponseTimeStr() {
        return maxResponseTimeStr;
    }

    @Transient
    public long getAvgResponseTime() {
        return BigDecimal.valueOf(getTotalResponseTime())
                .divide(BigDecimal.valueOf(getTotalCount() == 0 ? 1 : getTotalCount()), 0, RoundingMode.HALF_UP).longValue();
    }
    ...
    public void initViewValues(){
        if (getTotalCount()==0){
            ...
            avgResponseTimeStr = getAvgResponseTime()+"";
            minResponseTimeStr = getMinResponseTime()+"";
            maxResponseTimeStr = getMaxResponseTime()+"";
        }
    }
